...
const ArrowBack_1 = (0, tslib_1.__importDefault)(require("@material-ui/icons/ArrowBack"));
const login_1 = require("./login/login");
const create_account_1 = require("./create-account/create-account");
const recovery_account_1 = require("./recovery-account/recovery-account");
