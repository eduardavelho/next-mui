...
const BottomNavigation_1 = (0, tslib_1.__importDefault)(require("@material-ui/core/BottomNavigation"));
const BottomNavigationAction_1 = (0, tslib_1.__importDefault)(require("@material-ui/core/BottomNavigationAction"));
...
function BottomNavigation({ items }) {
    ...
    const router = (_a = (0, router_1.useRouter)()) !== null && _a !== void 0 ? _a : { pathname: "/" };
    ...
    return (react_1.default.createElement(BottomNavigation_1.default, { value: value, onChange: (_, nextValue) => {
            ...
            position: "sticky",
            bottom: 0,
        }, showLabels: true }, items.map((_a) => {
        var { key, label, Icon } = _a, item = (0, tslib_1.__rest)(_a, ["key", "label", "Icon"]);
        return "href" in item ? (react_1.default.createElement(link_1.default, { href: item.href, passHref: true, key: key },
            react_1.default.createElement(BottomNavigationAction_1.default, { component: "a", value: item.href, label: label, icon: react_1.default.createElement(Icon, null), showLabel: true, className: item.href === value ? "Mui-selected" : undefined }))) : (react_1.default.createElement(BottomNavigationAction_1.default, { key: key, value: key, onClick: item.onClick, label: label, icon: react_1.default.createElement(Icon, null), showLabel: true, style: {
                cursor: "pointer",
            } }));
    })));
}
