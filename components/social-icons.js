...
const SvgIcon_1 = (0, tslib_1.__importDefault)(require("@material-ui/core/SvgIcon"));
const Facebook_1 = (0, tslib_1.__importDefault)(require("@material-ui/icons/Facebook"));
const Twitter_1 = (0, tslib_1.__importDefault)(require("@material-ui/icons/Twitter"));
const WhatsApp_1 = (0, tslib_1.__importDefault)(require("@material-ui/icons/WhatsApp"));
const LinkedIn_1 = (0, tslib_1.__importDefault)(require("@material-ui/icons/LinkedIn"));
const Instagram_1 = (0, tslib_1.__importDefault)(require("@material-ui/icons/Instagram"));
const Email_1 = (0, tslib_1.__importDefault)(require("@material-ui/icons/Email"));
const icons = [
    [
        "facebook",
        Facebook_1.default,
...
function SocialIcons(props) {
    const { socialAnchorTitle, smallIcons, largeIcons, iconsInheritFontSize } = props, socialIcons = (0, tslib_1.__rest)(props, ["socialAnchorTitle", "smallIcons", "largeIcons", "iconsInheritFontSize"]);
    ...
    return (react_1.default.createElement(Box_1.default, { display: "inline-flex" }, icons
        ...
        .map(([icon, Icon, color, getHref, name], index) => (react_1.default.createElement(Box_1.default, { marginLeft: index && 1.6, display: "inline-flex", key: name },
