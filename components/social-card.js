...
function SocialCard(_a) {
    var { name, nameColor, description, about, picture, tags, elevation } = _a, socialIconsProps = (0, tslib_1.__rest)(_a, ["name", "nameColor", "description", "about", "picture", "tags", "elevation"]);
    ...
    return (react_1.default.createElement(Card_1.default, { elevation: elevation },
        react_1.default.createElement(CardContent_1.default, { style: {
            ...
            tags !== undefined && tags.length > 0 && (react_1.default.createElement(Box_1.default, null, tags.map(({ key, tag }) => (react_1.default.createElement(Chip_1.default, { key: key, size: "small", label: tag, style: {
            ...
            react_1.default.createElement(ListItem_1.default, { component: "div", alignItems: "flex-start", style: {
                ...
                react_1.default.createElement(ListItemText_1.default, { primary: react_1.default.createElement("span", { style: { color: nameColor || theme.palette.primary.main } }, name), secondary: description })),
