...
const react_infinite_scroll_component_1 = (0, tslib_1.__importDefault)(require("react-infinite-scroll-component"));
...
function InfiniteScroll({ onRequestMoreItems, hasMoreItems, itemsLength, children, }) {
    return (react_1.default.createElement(react_infinite_scroll_component_1.default, { dataLength: itemsLength, next: onRequestMoreItems, hasMore: hasMoreItems, style: {
            overflow: "initial",
        }, loader: react_1.default.createElement(Box_1.default, { paddingTop: 1.6, display: "flex", justifyContent: "center" },
