...
const Card_1 = (0, tslib_1.__importDefault)(require("@material-ui/core/Card"));
const CardActionArea_1 = (0, tslib_1.__importDefault)(require("@material-ui/core/CardActionArea"));
const CardContent_1 = (0, tslib_1.__importDefault)(require("@material-ui/core/CardContent"));
const CardMedia_1 = (0, tslib_1.__importDefault)(require("@material-ui/core/CardMedia"));
...
const Favorite_1 = (0, tslib_1.__importDefault)(require("@material-ui/icons/Favorite"));
const ModeComment_1 = (0, tslib_1.__importDefault)(require("@material-ui/icons/ModeComment"));
const Visibility_1 = (0, tslib_1.__importDefault)(require("@material-ui/icons/Visibility"));
function PostCard(_a) {
    var { title, subtitle, image, date, dateText, likes, likesAriaLabel, comments, commentsAriaLabel, views, viewsAriaLabel, authorName, authorPicture, tags, titleColor, elevation } = _a, props = (0, tslib_1.__rest)(_a, ["title", "subtitle", "image", "date", "dateText", "likes", "likesAriaLabel", "comments", "commentsAriaLabel", "views", "viewsAriaLabel", "authorName", "authorPicture", "tags", "titleColor", "elevation"]);
    ...
    const postCard = (react_1.default.createElement(Card_1.default, { elevation: elevation, onClick: () => "onClick" in props && props.onClick() },
        react_1.default.createElement(CardActionArea_1.default, null,
            image && (react_1.default.createElement(CardMedia_1.default, { image: image, title: title, style: {
                    height: "140px",
                } })),
            ...
            react_1.default.createElement(CardContent_1.default, null,
                tags !== undefined && tags.length > 0 && (react_1.default.createElement(Box_1.default, { marginTop: 0.8, marginBottom: 2.4 }, tags.map(({ key, tag }) => (react_1.default.createElement(Chip_1.default, { key: key, size: "small", label: tag, style: {
                        marginBottom: theme.spacing(0.3),
                        marginRight: theme.spacing(0.3),
                        cursor: "pointer",
                    } }))))),
                date !== undefined && (react_1.default.createElement(Box_1.default, null,
                    react_1.default.createElement(Typography_1.default, { variant: "caption", component: "time", dateTime: date.toISOString() }, dateText || date.toLocaleString()))),
                title && (react_1.default.createElement(Box_1.default, { marginBottom: subtitle ? 0.4 : undefined },
