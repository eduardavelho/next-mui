...
function InfiniteScrollGrid(_a) {
    var { hasMoreItems, onRequestMoreItems, items, mapItemToComponent } = _a, gridProps = (0, tslib_1.__rest)(_a, ["hasMoreItems", "onRequestMoreItems", "items", "mapItemToComponent"]);
    ...
    return (react_1.default.createElement(infinite_scroll_1.InfiniteScroll, { itemsLength: items.length, onRequestMoreItems: onRequestMoreItems, hasMoreItems: hasMoreItems },
        react_1.default.createElement(masonry_grid_1.MasonryGrid, Object.assign({ xl: 3, spacing: theme.spacing(2) }, gridProps), items.map((props) => (react_1.default.createElement(Box_1.default, { key: props.key }, mapItemToComponent(props)))))));
}
